...
import kjm.sample.keycloak.keycloak.keycloak.KeycloakServerProperties.AdminUser;
...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
    ...
    protected void loadConfig() {
        JsonConfigProviderFactory factory = new RegualrJsonConfigProviderFactory();
    ...
    private void createKeyCloakSampleRealm() {
        KeycloakSession session = getSessionFactory().create();
